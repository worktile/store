...
describe('Store: EntityStore with refs', () => {
    ...
    interface TaskDetailState extends EntityState<TaskInfo, TaskReferences> {}
    ...
    class TaskDetailStore
        extends EntityStore<TaskDetailState, TaskInfo, TaskReferences>
    ...
    let initialTaskDetail: TaskInfo;
    ...
    describe('Store: EntityStore with entities and refs', () => {
    ...
    describe('Store: EntityStore with entity and refs', () => {
        it('should get initial data when call store initialize', () => {
            const taskDetailStore = injectStoreForTest(TaskDetailStore);
            taskDetailStore.initializeWithReferences(initialTaskDetail, { groups: initialGroups });
        ...
        it('should get correct refs by entitiesWithRefs$', () => {
            const taskDetailStore = injectStoreForTest(
                TaskDetailStore,
                {
                    entity: initialTaskDetail,
                    references: { groups: initialGroups, users: initialUsers }
                },
                {
                    referencesIdKeys: {
        ...
        it(`update with new group`, () => {
            ...
            expect(state.references.groups).toEqual([...initialGroups, group4]);
        });
